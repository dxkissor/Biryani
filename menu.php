   ...
   <div class="menu">
     ...
     <div class="container">
          <div class="box1">
                  ...
                  <a href="chicken.php"><input type="button" name="View" value="View all" >
          </div>
          <div class="box1">
                  <h1>MOUTTON</h1>
                  <img  id="moutton" src="moutton.jpg" alt="moutton"><br>
                  <a href="moutton.php"><input type="button" name="View" value="View all" >
          </div>
          <div class="box1">
                  <h2>STATE SPECIAL</h2>
                  <img  id="state" src="state.jpeg" alt="state"><br>
                  <a href="state.php"><input type="button" name="View" value="View all" >
          </div>
          <div class="box1">
                  <h1>OTHERS</h1>
                  <img  id="others" src="others.jpg" alt="others"><br>
                  <a href=others.php><input type="button" name="View" value="View all" >
          </div>
      </div>
   </div>
   <footer>
