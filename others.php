   ...
   <div class="menu">
     ...
     <div class="container">
          <div class="box1">
                  ...
                  <form action="payment.php"><input type="submit" name="itemID" value="o1"></form>
          </div>
          <div class="box1">
                  <h1>MALABAR BIRYANI</h1>
                  <img  id="moutton" src="moutton.jpg" alt="moutton"><br>
               <form action="payment.php"><input type="submit" name="itemID" value="o2"></form>
          </div>
          <div class="box1">
                  <h2>AMBUR BIRYANI</h2>
                  <img  id="state" src="state.jpeg" alt="state"><br>
                  <form action="payment.php"><input type="submit" name="itemID" value="o3"></form>
          </div>
          <div class="box1">
                  <h1>BHATKALI BIRYANI</h1>
                  <img  id="others" src="others.jpg" alt="others"><br>
                  <form action="payment.php"><input type="submit" name="itemID" value="o4"></form>
          </div>
      </div>
   </div>
   <footer>
